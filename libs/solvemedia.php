...
function solvemedia_get_html ($pubkey, $error = null, $use_ssl = 'no')
{
	if ($pubkey == null || $pubkey == '') {
		$error =  '<div class="alert alert-danger">To use solvemedia you must get an API key from <a href="'.ADCOPY_SIGNUP.'">'.ADCOPY_SIGNUP.'</a></div>';
		return $error;
	}
	...
	if ($use_ssl == 'yes') {
        ...
        return '<div style="margin: 0 auto 4px;max-width: 308px;overflow: hidden;">
